...
namespace SistemaInventarios.Controllers
{
    public class ArticuloesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdArticulo,NombreArt,CantidadArt,DescripcionArt")] Articulo articulo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdArticulo,NombreArt,CantidadArt,DescripcionArt")] Articulo articulo)
        {
            if (ModelState.IsValid)
            {
